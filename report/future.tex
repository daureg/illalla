...
what \keyfinding{limitations} can be addressed in further work. After
...
parameters and threshold}. That would be fine if they encode some prior
...
\keyfinding{unsupervised clustering methods}, for instance based on Euclidean
...
create \keyfinding{hand picked ground truth} by manually annoying tags and
...
information}---tags, location, user, time---we only work with the first two
